...
#define BLYNK_TEMPLATE_ID "TMPL6in-XYQkv"
#define BLYNK_TEMPLATE_NAME "DHT BY NOOR"
#define BLYNK_AUTH_TOKEN "qPx5zB4jVEfVn_GGw8hTqHGe9VneDxqK"// <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
